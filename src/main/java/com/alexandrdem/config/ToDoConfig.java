package com.alexandrdem.config;
...
@EnableJpaRepositories(basePackages = "com.alexandrdem.repositories")
public class ToDoConfig implements WebMvcConfigurer {

    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/webjars/**")
                .addResourceLocations("classpath:/META-INF/resource/webjars/", "/resources/", "/webjars/")
                .resourceChain(true)
    ...
    //Указывает какой механизм отображения будет использован (JSP, JSF ...)
    @Bean
